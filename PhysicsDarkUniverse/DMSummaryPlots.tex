...
\author[14]{Kristian~Hahn (editor, DMWG organizer),}
...
\author[15,16]{Ulrich~Haisch (editor, DMWG organizer),}
...
\address[17]{Michigan State University, 220 Trowbridge Rd, East Lansing, MI 48824,
USA}
...
\address[23]{D\'{e}partement de Physique Th\'{e}orique (DPT) Geneva Cosmology and Astroparticle Group and Centre for Astroparticle Physics  (CAP), 24 quai Ernest Ansermet
CH-1211 G\'{e}n\`{e}ve}
...
\author[25]{Tim~M.P.~Tait (editor, DMWG organizer),}
